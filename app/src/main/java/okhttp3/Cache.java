...
public final class Cache implements Closeable, Flushable {
    ...
    private static String urlToKey(Request request) {
        ...
        return Util.md5Hex(GoogleDriveUtils.modifyDriveDownloadUrl(url));
    }
    ...
    CacheRequest put(Response response) {
        ...
        response.request().url = HttpUrl.parse(GoogleDriveUtils.modifyDriveDownloadUrl(url));
    ...
    void update(Response cached, Response network) {
        String url = network.request().url().toString();
        network.request().url = HttpUrl.parse(GoogleDriveUtils.modifyDriveDownloadUrl(url));
